    ...
    >
      ...
      <div v-else-if="section == 'langues'">
        <div class="mx-2">
          <div class="row">
            <div class="col-md-6">
              <b-field label="Ajouter au plus cinq(5) langues" size="is-medium">
              </b-field>
            </div>
      ...
      <div v-else-if="section == 'infosSupp'">
          ...
          >
            ...
            <template v-else #trigger>
              <b-field>
                ...
                <p class="control">
                  <b-input style="border-color: #24855a" disabled placeholder="">
                  </b-input>
                </p>
              </b-field>
            </template>
        ...
        <b-field custom-class="is-medium" class="form-label" :type="type.infosSupp.genre">
          ...
          <b-input
            type="textarea"
            maxlength="300"
            v-model="userInfos.infosSupp.decla_pers"
          >
          </b-input>
        </b-field>
      </div>
    ...
    async operations(position, action) {
      ...
      if (Object.keys(this.errors).length == 0) {
        if (position == "experience" && action == "create") {
          let newExperience = await this.addExperienceApi();
          this.$emit("add-experience", newExperience);
          this.handleCancel();
