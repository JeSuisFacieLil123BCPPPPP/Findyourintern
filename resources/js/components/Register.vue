      ...
      <v-row>
        ...
        <v-col sm="6" cols="12">
          <div>
            <a-card>
              <section></section>
              <h1 class="login-title my-2">S'inscrire</h1>
              <span>Bienvenue à vous ! Inscrivez-vous sur notre plateforme.</span>
              <section class="mt-5">
                <v-row>
                  <v-col cols="12">
                    <b-field
                  ...
                  <!--<v-col cols="12">
                    <vs-alert>
                      <div class="list-item-group label-text">
                        Un compte étudiant : vous pourrez disposerd'un profil étudiant
                        avec CV,réalisations, portfolio..
                      </div>
                      <div class="list-item-group label-text">
                        Un compte étudiant : vous pourrez disposerd'un profil étudiant
                        avec CV,réalisations, portfolio..
                    ...
                    <v-alert border="left" colored-border color="#24855a" elevation="0">
                      <div class="list-item-group label-text">
                        Un compte étudiant : vous pourrez disposerd'un profil étudiant
                        avec CV,réalisations, portfolio..
                      </div>
                    ...
                    <b-message class="label-text" type="is-info"
                      ><div class="list-item-group label-text">
                        Un compte étudiant : vous pourrez disposerd'un profil étudiant
                        avec CV,réalisations, portfolio..
                      </div>
